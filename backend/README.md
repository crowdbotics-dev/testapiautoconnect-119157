...
## Project Structure
    ...
    ├── testapiautoconnect_119157  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_119157`
...
2. Clone this repo and `cd testapiautoconnect_119157`
